...
class RestaurantServiceTest {
    ...
    void getAllRestaurants_returnsListFromRepository() {
        ...
        com.platterops.subscription.SubscriptionRepository subscriptionRepository = Mockito.mock(com.platterops.subscription.SubscriptionRepository.class);
        RestaurantService service = new RestaurantService(repo, userRepository, reviewService, subscriptionRepository);
